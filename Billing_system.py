...
#================totalBill==========================
    ...
    def total(self):
        ...
        self.m_s_p = self.sanitizer.get()*10
        ...
        self.c_tax = round((self.total_medical_price*0.35), 2)
        ...
        self.g_d_p = self.daal.get()*12
        self.g_f_p = self.flour.get()*15
        ...
        self.g_tax = round((self.total_grocery_price*0.65), 2)
        ...
        self.c_d_tax = round((self.total_cold_drinks_price * 0.4), 2)
...
#==============welcome-bill==============================
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\t Patel Store")
